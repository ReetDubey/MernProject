  ...
  render () {
    ...
    return (
      <div className="Registration">
        <h1 className="heading"> {REGISTRATION_FIELDS.REGISTRATION_HEADING} </h1> <form
          onSubmit={this.onSubmit}
        >
          <div>
            <div className="fields">
              <p className="fields-input"> {REGISTRATION_FIELDS.FIRST_NAME} </p>
              {' '}
              <input
                type="text"
              ...
              <p className="fields-input"> {REGISTRATION_FIELDS.LAST_NAME} </p>
              {' '}
              <input
                type="text"
              ...
              <p className="fields-input"> {COMMON_FIELDS.USER_NAME} </p>
              {' '}
              <input
                type="text"
              ...
              <p className="fields-input"> {COMMON_FIELDS.PASSWORD} </p>
              {' '}
              <input
                type="password"
